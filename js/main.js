...
(function($) {
    ...
    if ( _mainJS ) {
        ...
        if ( document.querySelector('[data-wrapper="letters-effect"]') ) {
          ...
          ease_js.src    = './index_files/ease.js';
          letters_js.src = './index_files/letters.js';
          segment_js.src = './index_files/segment.min.js';
          mo_js.src      = './index_files/mo.min.js';
          effects.src    = './index_files/effects.js';
        ...
        if ( document.querySelector('[data-scrollbar]') ) {
            ...
            nicescroll_js.src = './index_files/jquery.nicescroll.min.js';
        ...
        if ( document.querySelector('[data-animated-background]') ) {
            ...
            TweenMax_js.src = './index_files/TweenMax.min.js';
            ...
            if ( (document.querySelector('[data-animated-background="effect-4"]')) ) {
                ...
                three_js.src  = './index_files/three.min.js';
                perlin_js.src = './index_files/perlin.js';
            ...
            window.addEventListener('load', function () {
                ...
                if ( document.querySelector('[data-animated-background="effect-4"]') ) {
                  ...
                  bg_effect_4_js.src = './index_files/effect-4.js';
